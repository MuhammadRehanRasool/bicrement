...
const LoginExplore = () => {
    return (
        <div className="flex flex-col items-center shadow-lg  rounded-b-2xl relative">
            <div className="flex">
                <button className="bg-blues-button text-yellows-dark w-44 py-3 rounded-r-full rounded-tl-full">
                    Log In
                </button>
            ...
            <div className="px-6 py-8 w-full">
                ...
                <div className="flex justify-end mt-8">
                    <button className="bg-yellows-light text-white w-44 py-3 rounded-full ">
                        Enter
                    </button>
                </div>
            </div>
