...
const CoursesSearchBar = ({children}) => {
    ...
    return (
        <div className="">
            <div
                className="border border-grays-light rounded-full shadow bg-white text-xs  flex items-center space-x-2  h-10 w-1/2"
            ...
            <div className="w-full flex justify-between items-center flex-col mt-5">
                <div className=" h-32 rounded-t-lg rounded-r-lg bg-gray-100 flex items-center p-5 space-x-1">
                    {/* logo */}
                    <div className="logo w-1/5 flex justify-between items-center flex-col">
